...
public class StatesManager : MonoBehaviour
{
    ...
    public static void Initiate()
    {
        ...
        gameStates.Add("Intro_2", new State(name: "Introduction Second Screen", isLvl: false, isCutScn: true, positiveState: "1lvl_1", negativeState: null)); // revert to 1lvl_1   OR 2lvl_1
        ...
        gameStates.Add("2lvl_1", new State(name: "Second Level Gameplay", isLvl: true, isCutScn: false, positiveState: "2lvl_2", negativeState: "2lvl_3"));
