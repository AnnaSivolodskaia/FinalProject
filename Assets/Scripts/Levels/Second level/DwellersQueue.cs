...
public class DwellersQueue : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        possibleQueuePlaces = new Dictionary<string, List<List<float>>>
        {
            ...
            { "fourth_queue", new List<List<float>> { new List<float> { 136f, 7f }, new List<float> { 134, 3.5f }, new List<float> { 133.5f, 0f }, new List<float> { 132f, -3.5f }, new List<float> { 131f, -6f } } }
        };
